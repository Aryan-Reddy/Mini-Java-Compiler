...
public class Env
{
	...
	public String getVarClassName(String id)
	{
		Env curEnv = this;
		while(curEnv != null)
		{
			String poss = (String) curEnv.idTypeTable.get(id);
			if(poss!=null) return curEnv.className;
			curEnv = curEnv.parent;
		}
		return null;
	}
	public String getFunClassName(String id)
	{
		Env curEnv = this;
		while(curEnv != null)
		{
			MethodAttr poss =  curEnv.methodTable.get(id);
			if(poss!=null) return curEnv.className;
			curEnv = curEnv.parent;
		}
		return null;
	...
	public String[] getIdsPresent()
	{
		Set<String> tempKeys = idTypeTable.keySet();
		String[] ret = new String[tempKeys.size()];
		int c = 0;
		for(String k:tempKeys) {ret[c] = k;c++;}
		return ret;
	}
}