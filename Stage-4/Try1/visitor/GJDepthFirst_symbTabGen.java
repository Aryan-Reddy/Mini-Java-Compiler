...
public class GJDepthFirst_symbTabGen<R,A> implements GJVisitor<R,A> {
  ...
  int curMxArgs;
   public GJDepthFirst_symbTabGen(SymbolTable2 tb,Integer regCnt,Integer calleeSavedCnt)
   {
    super();
    tab = tb;
    curStmtCnt = 1;
    ...
    callerSavedCount = regCnt - calleeSavedCnt;
   }
   ...
   class LinearScan
   {
    ...
    {
      makeIntervals();
      //System.out.println(curProcedure + ": ");
   ...
   public R visit(Goal n, A argu) {
      ...
      curLinScan.addV(new TreeSet<Integer>(),new TreeSet<Integer>());
      curLinScan.addE(curStmtCnt-1,curStmtCnt);
      curStmtCnt++;
      TreeMap<Integer,Integer> allocM = curLinScan.getAllocation();
      Integer argCnt = 0;
      Integer spilledLocal = Math.max(Collections.max(allocM.values()) - registerCount + 1,0);
      if(spilledLocal > 0) tab.spillInfo.put(curProcedure,true);
      else tab.spillInfo.put(curProcedure,false);
      Integer spilledCnt = spilledLocal + (curMxArgs == -1 ? 0 : callerSavedCount);
      Vector<Integer> temp = new Vector<Integer>();
      temp.addElement(argCnt);
      temp.addElement(spilledCnt);
      temp.addElement(Math.max(curMxArgs,0));
      tab.proc3ints.put(curProcedure,temp);
      tab.putMap(curProcedure,allocM);
   ...
   public R visit(Procedure n, A argu) {
      ...
      curMxArgs = -1;
      n.f1.accept(this, argu);
      String procArgCnt = (String) n.f2.accept(this, argu);
      n.f3.accept(this, argu);
      n.f4.accept(this, argu);
      Set<Integer> k = stmtToLabelEdgs.keySet();
      for(int x:k)
      ...
      curStmtCnt++;
      TreeMap<Integer,Integer> allocM = curLinScan.getAllocation();
      Integer argCnt = Integer.valueOf(procArgCnt);
      Integer spilledLocal = Math.max(Collections.max(allocM.values()) - registerCount + 1,0);
      if(spilledLocal > 0) tab.spillInfo.put(curProcedure,true);
      else tab.spillInfo.put(curProcedure,false);
      Integer argSlotspace = Math.max(argCnt,4)-4;
      Integer spilledCnt = spilledLocal + (curMxArgs == -1 ? 0 : callerSavedCount) + calleeSavedCount + argSlotspace;
      Vector<Integer> temp = new Vector<Integer>();
      temp.addElement(argCnt);
      temp.addElement(spilledCnt);
      temp.addElement(Math.max(curMxArgs,0));
   ...
   public R visit(Stmt n, A argu) {
      ...
      if(arg!=null && arg.equals("fromStmtList"))
      {
   ...
   public R visit(NoOpStmt n, A argu) {
      R _ret=null;
      String arg = (String) argu;
      if(arg!=null && arg.equals("fromStmtScan"))
      {
        argu = null;
      }
      n.f0.accept(this, argu);
   ...
   public R visit(Call n, A argu) {
      ...
      curMxArgs = Math.max(curMxArgs,collectArgs.size());
   ...
   public R visit(SimpleExp n, A argu) {
      ...
      if(arg!=null && (arg.equals("fromStmtScan") || arg.equals("fromReturn")))
      {
        if(n.f0.which==0)
        {
